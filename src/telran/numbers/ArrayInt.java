...
public class ArrayInt {
	 ...
	 * @param ar
	 * @param number
	 * @return index of value if given number of first occurrence exist in array or
	 *         -1 if doesn't exist
	 */
...
//	}
	 ...
	 * @param number
	 * @return if the given number exist in the given array then returns the index
	 *         of first occurrence, otherwise returns negative value of (index + 1)
	 *         where index is the index at which position given element should have
	 *         been
	 * 
	 */
