...
class StringsStandardTests {
	...
	void equalsStrings () {
		...
		String str2 = "Hello"; // Java recognizes array of chars existence and put reference to that array
		String str3 = new String ("Hello"); //Java creates new array and fills it with existed array of chars
	...
	void comparingStrings () {
		String str1 = "123456789"; // this is not number!!!! 
		String str2 = "ab";
		String str3 = "Ab";
		String str4 = "aB";
		...
		assertEquals(0, str2.compareToIgnoreCase(str3));
